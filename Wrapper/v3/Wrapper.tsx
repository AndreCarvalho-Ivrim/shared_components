...
export const Wrapper = ({ breadcrumbs, children, asideItems, asideActive, module_name }: WrapperProps) => (
  <div className="w-screen h-screen bg-gradient-bg sm:p-4 !pr-0">
    ...
    ">
      <Aside items={asideItems} active={asideActive} module_name={module_name}/>
