...
export const WhatsappIcon = (props: IconProps) => (
  <svg fill="#ffffff" width={props.w ?? "24"} height={props.h ?? "24"} viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
...
export const listAvailableIcons = [
  ...
  {component: <WhatsappIcon/>,            title: 'WhatsappIcon'             },
];
